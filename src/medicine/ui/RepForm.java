...
public final class RepForm extends javax.swing.JInternalFrame {
    ...
    public void loadCompanyList() {
        ...
        companyList = companyDao.display();
    ...
    private void cbSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSearchActionPerformed
        ...
        try {
            ...
            if (client != null) {
                ...
                cbCompany.getModel().setSelectedItem(client.getCompany());
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (firstName.trim().equals("")) {
            ...
            try {
                ...
                client.setPresentDistrict(null);
                client.setUser(user);
