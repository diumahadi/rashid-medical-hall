...
public final class LocationForm extends javax.swing.JInternalFrame {

    private User user;
    private Location location;
    private List<Location> locationList = new ArrayList<>();

    public LocationForm(User user) {
        initComponents();
        this.user = user;
        loadLocationList();
        enableButtons();
    ...
    public void loadLocationList() {
        ...
        locationList = locationDao.display();
    ...
    private void initComponents() {
        ...
        tfLocationName.setText("jTextField1");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (locationName.trim().equals("")) {
            JOptionPane.showMessageDialog(this, "Insert Location ???");
        } else {
            try {
                location = new Location();
                if (cbDisplay.getSelectedIndex() == 1) {
                    location.setDisplay(0);
                } else {
                    location.setDisplay(1);
                }
    ...
    private void cbSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSearchActionPerformed
        ...
        try {
            location = (Location) cbSearch.getSelectedItem();
            if (location != null) {
                tfLocationName.setText(location.getLocationName());
                if (location.getDisplay() == 1) {
                    cbDisplay.setSelectedIndex(0);
                } else {
