...
public final class PSForm extends javax.swing.JInternalFrame {

    private final User user;
    private PSTitle pSTitle;
    private List<PSTitle> titleList = new ArrayList<>();

    public PSForm(User user) {
        initComponents();
        this.user = user;
        loadTitle();
        enableButtons();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String pstitle = tfTitle.getText();

        if (pstitle.trim().equals("")) {
            JOptionPane.showMessageDialog(this, "Insert Title ???");
        } else {
            try {
                pSTitle = new PSTitle();
                pSTitle.setTitle(pstitle);
                if (cbDisplay.getSelectedIndex() == 1) {
                    pSTitle.setDisplay(0);
                } else {
                    pSTitle.setDisplay(1);
                }
                pSTitle.setUser(user);
                PSTitleDao pSTitleDao = new PSTitleDao();
                if (pSTitleDao.save(pSTitle)) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (check == 0) {
            PSTitleDao dao = new PSTitleDao();
            if (dao.delete(pSTitle)) {
    ...
    private void cbSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSearchActionPerformed
        ...
        try {
            pSTitle=(PSTitle) cbSearch.getSelectedItem();
            if(pSTitle !=null){
                tfTitle.setText(pSTitle.getTitle());
                if (pSTitle.getDisplay() == 1) {
                    cbDisplay.setSelectedIndex(0);
                } else {
