...
public final class CustomerPaymentUI extends javax.swing.JInternalFrame {

    private final User user;
    private ClientPayment payment;
    private ClientDao clientDao;
    private ClientPaymentDao paymentDao;
    private List<Client> repList = new ArrayList<>();

    public CustomerPaymentUI(User user) {
        initComponents();
        this.user = user;
        enableButtons();
        clearForm();
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        ...
        if (!paymentId.trim().equals("")) {
            ...
            if (payment.getClient() != null) {
                disableButtons();
                cbCustomer.getModel().setSelectedItem(payment.getClient());
                paymentDao = new ClientPaymentDao();
    ...
    private void cbCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbCustomerActionPerformed
        ...
        try {
            ...
            double totalDue = paymentDao.getTotalSalesDue(c);
            double totalPaid = paymentDao.getTotalPayment(c, "SP");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (paidAmount.trim().equals("")) {
            ...
            try {
                ...
                payment.setClient((Client) cbCustomer.getSelectedItem());
