...
public class PurchaseReturnReportUI extends javax.swing.JInternalFrame {
    ...
    private void btnFindAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindAllActionPerformed
        ...
        try {
            ...
            dtm.addRow(new Object[]{
                "SN", "RETURN ID", "REPRESENTATIVE & COMPANY", "DATE"
            });

            returnDao = new PurchaseReturnDao();
            int i = 1;
            for (PurchaseReturnMaster mas : returnDao.display()) {
                dtm.addRow(new Object[]{
                    i,
                    mas.getReturnId(),
            ...
            frame.setTitle("PURCHASE RETURN LIST");
    ...
    public void showReport(String invoiceId) {
        ...
        hashMap.put("FORMATTED_ID", "PR".concat(idFormat));
        hashMap.put("RETURN_ID", Long.parseLong(invoiceId));
        hashMap.put("REP_NAME", customer);
        hashMap.put("RETURN_DATE", master.getReturnDate());
        reportViewer = new ReportUtil("reports/PURCHASE_RETURN_INVOICE.jasper", hashMap);
